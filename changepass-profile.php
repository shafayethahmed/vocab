...
<head>
    ...
    <style>
        ...
        /* Modal Base Styles (for both Edit Profile and Change Password) */
        .modal {
            display: none;
            position: fixed;
            z-index: 1001;
...
<body> 
        ...
        <div id="changePasswordModal" class="modal">
            <div class="modal-content">
                ...
                <form id="changePasswordForm" action="#">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="save-button" id="change-password-button" onclick="changePassword()" disabled>
    ...
    <script>
        ...
        const submissionDays = ['2025-03-01', '2025-03-05', '2025-03-10', '2025-03-15', '2025-03-16', '2025-03-20', '2025-03-25', '2025-03-26', '2025-03-27'];
