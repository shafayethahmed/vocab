<?php 
//if password and retype password are same in  signup Then Display this Error!
  echo "
  <script>
      document.addEventListener('DOMContentLoaded', function() {
          let alertBox = document.createElement('div');
          alertBox.innerHTML = 'Password must be same! Please try again.';     
          // Styling the alert box
          alertBox.style.position = 'fixed';
          alertBox.style.top = '110px';
          alertBox.style.left = '61%';
          alertBox.style.transform = 'translateX(-50%)';
          alertBox.style.backgroundColor = '#FF8080';
